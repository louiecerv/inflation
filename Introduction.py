...
def app():
    ...
    st.write(text)  
    st.markdown("Balajadia, Arianne V., Comorro, Kyle Avefern B., Daria, Niña Paula C., Erazo, \
        Josephine Aurea E., and Granada, Shaneen Joy A. *Awareness and Perception on Inflation \
        Among Job Order Workers in a State University* Unpublished undergraduate thesis. (2024)")
